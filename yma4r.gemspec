Gem::Specification.new do |s|
  ...
  s.files = ["README", "ChangeLog", "Rakefile", "spec/spec.opts", "spec/spec_helper.rb", "spec/yma4r_spec.rb", "spec/yma_parser_spec.rb", "lib/yma4r.rb", "lib/yma_parser.rb"]
  s.has_rdoc = false
  ...
  s.test_files = ["spec/yma4r_spec.rb", "spec/yma_parser_spec.rb"]
